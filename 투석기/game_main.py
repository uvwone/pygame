...
if __name__ == "__main__":
      ...
      crash_sound = pygame.mixer.Sond('crash.ogg')
      ...
      while run:
            ...
            if alien.alive():
                  collided = pygame.sprite.groupcollide(
                        stone_gorup, alien_group, False, True)
                  ...
                  if collided:
                        ...
                        explosion.rect.y = \
                              (alien.rect.y + aline.rect.height/2) - \
                  ...
                  if alien.aliv() and stone_count == 0:
                        game_state = GAME_OVER

                  if game_state == GAME_PLAY:         #게임 없데이트
                  ...
                  if game_state == GAME_INIT:
                        ...
                        title_pos = (screen.get_width()/2 - title_szie[0]/2, 100)
